		...
		{  
			...
			{  
				...
				{  
					...
					{  
						if(token.equalsIgnoreCase("Browser/App") || token.equalsIgnoreCase(" Environment") || token.equalsIgnoreCase("Chrome") || token.equalsIgnoreCase("Winvinaya-Foundation-website") || 
