...
//		createDetailReport();
	...
	public static void createDetailReport() {
		...
		// This will create the report file call this before start of testing
		String reportFile = "target/DetailReport.csv";
	...
	public static void createFailureReport() {
		...
		// This will create the report file call this before start of testing
		String reportFile = "target/FailureReport.csv";
	...
	private static void writeHeader() {
		// Create record
		String[] record = "Browser/App, Environment, SL-NO, COURSE_NAME, TEAM_NAME, SESSION_END_DATE, EXECUTION RESULT , TIME STAMP".split(",");
	...
	private static void writeFailureHeader() {
		// Create record
		String[] record = "Browser/App, Environment, SL-NO, COURSE_NAME, TEAM_NAME, SESSION_END_DATE, EXECUTION RESULT , TIME STAMP".split(",");// Write the record to file
		if (repWriterFailure != null)
